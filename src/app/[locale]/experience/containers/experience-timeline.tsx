  ...
  const EXPERIENCE_TIMELINE = [
    {
      ...
      content: (
        <div>
          ...
          <p 
            className="text-neutral-800 dark:text-neutral-200 text-sm md:text-base font-normal mb-4"
            dangerouslySetInnerHTML={{ __html: t('odc.intro') }}
          />
          
          <p 
            className="text-neutral-800 dark:text-neutral-200 text-sm md:text-base font-normal mb-6"
            dangerouslySetInnerHTML={{ __html: t('odc.description') }}
          />
          
          <div className="mb-8 space-y-2">
            <div className="flex gap-2 items-start text-neutral-700 dark:text-neutral-300 text-sm md:text-base">
              🔹 <span>{t('odc.features.detection')}</span>
            </div>
            <div className="flex gap-2 items-start text-neutral-700 dark:text-neutral-300 text-sm md:text-base">
              🔹 <span>{t('odc.features.recognition')}</span>
            </div>
            <div className="flex gap-2 items-start text-neutral-700 dark:text-neutral-300 text-sm md:text-base">
              🔹 <span>{t('odc.features.measurement')}</span>
            </div>
          </div>
    ...
    },
    {
      ...
      content: (
        <div>
          ...
          <p 
            className="text-neutral-800 dark:text-neutral-200 text-sm md:text-base font-normal mb-6"
            dangerouslySetInnerHTML={{ __html: t('teima.description') }}
          />
          
          <div className="mb-8 space-y-2">
            <div className="flex gap-2 items-start text-neutral-700 dark:text-neutral-300 text-sm md:text-base">
              ✅ <span>{t('teima.features.ui')}</span>
            </div>
            <div className="flex gap-2 items-start text-neutral-700 dark:text-neutral-300 text-sm md:text-base">
              ✅ <span>{t('teima.features.database')}</span>
            </div>
            <div className="flex gap-2 items-start text-neutral-700 dark:text-neutral-300 text-sm md:text-base">
              ✅ <span>{t('teima.features.payment')}</span>
            </div>
          </div>
    ...
    },
    {
      ...
      content: (
        <div>
          ...
          <p 
            className="text-neutral-800 dark:text-neutral-200 text-sm md:text-base font-normal mb-6"
            dangerouslySetInnerHTML={{ __html: t('e2s.description') }}
          />
          
          <div className="mb-8 space-y-2">
            <div className="flex gap-2 items-start text-neutral-700 dark:text-neutral-300 text-sm md:text-base">
              ✅ <span>{t('e2s.features.access')}</span>
            </div>
            <div className="flex gap-2 items-start text-neutral-700 dark:text-neutral-300 text-sm md:text-base">
              ✅ <span>{t('e2s.features.stock')}</span>
            </div>
            <div className="flex gap-2 items-start text-neutral-700 dark:text-neutral-300 text-sm md:text-base">
              ✅ <span>{t('e2s.features.billing')}</span>
            </div>
          </div>
